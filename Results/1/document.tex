...
% --- Slide 1 ---
\begin{frame}[fragile]
\begin{textblock}{0.886}(0.099, 0.022)
...
\begin{textblock}{0.106}(0.099, 0.877)
  \begin{minipage}[b][0.026\paperheight]{\linewidth}
    \raggedright
    \fontsize{3}{3.3}\selectfont 05.02.2026
  \end{minipage}
\end{textblock}
...
\begin{frame}[fragile]
  ...
  \begin{textblock}{0.431}(0.554, 0.363)
    \begin{minipage}[t][0.495\paperheight]{\linewidth}
      \includegraphics[width=\linewidth,height=0.495\textheight,keepaspectratio]{extracted_media/image_1.png}
    \end{minipage}
  \end{textblock}
  \begin{textblock}{0.431}(0.554, 0.363)
    \begin{minipage}[t][0.495\paperheight]{\linewidth}
...
\begin{frame}[fragile]
  ...
  \begin{textblock}{0.886}(0.099, 0.226)
    \begin{minipage}[b][0.63\paperheight]{\linewidth}
      ...
      \begin{itemize}
        ...
        \item Code Modellierung: Code  Laufzeitfunktion, die die Laufzeit des Codes beschreibt
        \item Asymptotische Notation: Funktion  Wachstumsordnung, die das asymptotische Verhalten beschreibt
      \end{itemize}
    \end{minipage}
  \end{textblock}
  ...
  \begin{textblock}{0.106}(0.099, 0.928)
    \begin{minipage}[b][0.031\paperheight]{\linewidth}
      \raggedright
      \fontsize{3}{3.3}\selectfont Seite 4
    \end{minipage}
  \end{textblock}
...
\begin{frame}[fragile]
  ...
  \begin{textblock}{0.106}(0.099, 0.928)
    \begin{minipage}[b][0.031\paperheight]{\linewidth}
      \raggedright
      \fontsize{3}{3.3}\selectfont Seite 5
    \end{minipage}
  \end{textblock}
...
\begin{textblock}{0.106}(0.099, 0.928)
  \begin{minipage}[b][0.031\paperheight]{\linewidth}
    \raggedright
    \fontsize{3}{3.3}\selectfont Seite 6
  \end{minipage}
\end{textblock}
\end{frame}
...
\begin{textblock}{0.885}(0.099, 0.022)
  \begin{minipage}[b][0.031\paperheight]{\linewidth}
    {\tiny Algorithmik – Laufzeitanalyse von Algorithmen durch Asymptotische Notation}
  \end{minipage}
\end{textblock}
...
\begin{textblock}{0.18}(0.615, 0.934)
  \begin{minipage}[b][0.032\paperheight]{\linewidth}
    {\tiny CSE 373 20 SP – CHUN & CHAMPION}
  \end{minipage}
\end{textblock}

\begin{textblock}{0.231}(0.564, 0.897)
  \begin{minipage}[b][0.032\paperheight]{\linewidth}
    {\tiny Quelle: Data Structures and Algorithms (CSE 373), University of Washington, Spring 2022}
  \end{minipage}
\end{textblock}
...
\begin{frame}[fragile]
\begin{textblock}{0.885}(0.099, 0.022)
  \begin{minipage}[t][0.031\paperheight]{\linewidth}
    \raggedright
    \fontsize{3}{3.3}\selectfont Algorithmik – Laufzeitanalyse von Algorithmen durch Asymptotische Notation
  \end{minipage}
\end{textblock}
\begin{textblock}{0.12}(0.048, 0.335)
  \begin{minipage}[t][0.161\paperheight]{\linewidth}
    CODE
  \end{minipage}
\end{textblock}
\begin{textblock}{0.184}(0.185, 0.39)
  \begin{minipage}[t][0.054\paperheight]{\linewidth}
    Code Modellierung
  \end{minipage}
\end{textblock}
...
\begin{textblock}{0.101}(0.417, 0.503)
  ...
  \end{minipage}
\end{textblock}
\begin{textblock}{0.139}(0.598, 0.527)
  \begin{minipage}[t][0.161\paperheight]{\linewidth}
...
\begin{textblock}{0.063}(0.62, 0.192)
  ...
  \end{minipage}
\end{textblock}
\begin{textblock}{0.071}(0.931, 0.248)
